...
from bt_api_base.exceptions import ExchangeNotFoundError
...
class ExchangeRegistry:
    ...
    def _get_exchange_data_class(self, exchange_name: str) -> type[Any] | None:
        with self._lock:
            return self._exchange_data_classes.get(exchange_name)

    def _get_exchange_data_classes(self) -> dict[str, type[Any]]:
        with self._lock:
            return self._exchange_data_classes.copy()
    ...
    @classmethod
    def _cls_get_exchange_data_class(cls, exchange_name: str) -> type[Any] | None:
        return cls._get_default()._get_exchange_data_class(exchange_name)

    @classmethod
    def _cls_get_exchange_data_classes(cls) -> dict[str, type[Any]]:
        return cls._get_default()._get_exchange_data_classes()
    ...
    get_exchange_data_class = _ClassMethodOrInstance(
        "_cls_get_exchange_data_class", "_get_exchange_data_class"
    )
    get_exchange_data_classes = _ClassMethodOrInstance(
        "_cls_get_exchange_data_classes", "_get_exchange_data_classes"
    )
